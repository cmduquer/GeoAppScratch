...
declare module "@salesforce/schema/AccountChangeEvent.Location__Latitude__s" {
  const Location__Latitude__s:number;
  export default Location__Latitude__s;
}
declare module "@salesforce/schema/AccountChangeEvent.Location__Longitude__s" {
  const Location__Longitude__s:number;
  export default Location__Longitude__s;
}
declare module "@salesforce/schema/AccountChangeEvent.Location__c" {
